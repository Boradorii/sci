...
class predictService {
    ...
    async predict(params) {
        ...
        try {
            ...
            client.on('data', (data) => {
                ...
                let voltage_list = JSON.stringify(result["VOLTAGE"]);
                ...
                mysqlDB('insert', queryList.insert_measurement_result, [pet_id, age, gender, hr_list, hrv_list, voltage_list, sdnn, rmssd, pnn50, avg_hr, avg_hrv, glucos, high_pressure, low_pressure, predict_datetime])
            ...
            client.on('error', (error) => {
                ...
                let options = {
                    ...
                    args: [pet_id, hr, hrv, voltage, age, gender]
                };
    ...
    async insert_measurement_result(params) {
        ...
        let select_measurement_result = await mysqlDB('selectOne', queryList.insert_measurement_result, [pet_id, age, gender, hr, hrv, voltage, sdnn, rmssd, pnn50, hr_avg, hrv_avg, predict_glucose, predict_high_pressure, predict_low_pressure, datetime]);
