...
exports.insert_measurement_result = `
    INSERT INTO predict_data(pet_id, age, gender, hr, hrv, sdnn, rmssd, pnn50, hr_avg, hrv_avg, predict_glucose, predict_high_pressure, predict_low_pressure, created_time,user_code)
    VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?);
`;
