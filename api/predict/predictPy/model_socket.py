...
class predict:
    def __init__(self):
        ...
        # # 혈당(Ver 1.0) #
        # self.glucosmodel = tf.keras.models.load_model('/home/server/ppg_p_server/model/20230821_ppgbloodsugar_JSG_ver2_2.h5')
        # self.glucossc=load('/home/server/ppg_p_server/model/20230821_ppgbloodsugar_JSG_ver2_2.bin')
        ...
        # # 최고 혈압 #
        # self.highpressuremodel = tf.keras.models.load_model('/home/server/ppg_p_server/model/20230825_ppgbphigh_JSG_ver1_1.h5')  
        # self.highpressuresc=load('/home/server/ppg_p_server/model/20230825_ppgbphigh_JSG_ver1_1.bin')

        # self.raw_data_bphigh = pd.read_csv('/home/server/model_server/PPG_bphigh_0829.csv')
        # self.raw_data_1_bphigh = self.raw_data[['HR','HRV','SDNN','RMSSD','PNN50','VLF','LF','HF','HF_LF','gender','age']]
        # self.highpressuresc= self.highpressuresc.fit(self.raw_data_1_bphigh)

        # # 최저 혈압 #
        # self.lowpressuremodel = tf.keras.models.load_model('/home/server/ppg_p_server/model/20230801_bplow_JSG_ver2_1.h5')  
        # self.lowpressuresc=load('/home/server/ppg_p_server/model/20230801_bplow_JSG_ver2_1.bin')
