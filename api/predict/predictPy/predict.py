...
def insert_measurement_result(pet_id, age, gender, hr_list, hrv_list, voltage_list, sdnn, rmssd, pnn50, hr_avg, hrv_avg, predict_glucose, predict_high_pressure, predict_low_pressure):
    try:
        params = {
            'pet_id': pet_id,
            'age' : age,
        ...
        url = "https://192.168.3.154/api/predict/insert_measurement_result"
...
def health_predict(pet_id, hr, hrv, voltage, age, gender):
    try:
        print(datetime.now())
        hr =hr.replace('[', '')
        hrv =hrv.replace('[', '')
        ...
        insert_measurement_result(pet_id, age, gender, HR_LIST, HRV_LIST, VOLTAGE_LIST, SDNN_LIST[0], RMSSD_LIST[0], PNN50_LIST[0], hr_avg, hrv_avg, predict_glucose, predict_high_pressure, predict_low_pressure) 
    except Exception as e:
        print(str(e))
...
age=input()
gender=input()
print(pet_id, hr, hrv, voltage, age, gender)
health_predict(pet_id, hr, hrv, voltage, age, gender)