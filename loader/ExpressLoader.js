 ...
 *           2021.05.11 JG 정적 리소스 경로 추가(/app)
 *  ================================================================
 */
...
class ExpressLoader {
    constructor() {
        ...
        this.app.use(function (req, res, next) { // 404 error
            ...
            return res.render('app/error/errorPage', { // 에러 처리 페이지 이동 2021.04.30 JG
                'errorCode': 'ROUTERROR',
        ...
        this.app.use(function (error, req, res, next) { // other error
            ...
            logger.error(error);
            return res.render('app/error/errorPage', { // 에러 처리 페이지 이동 2021.05.07 JG
                'errorCode': 'SYSERROR',
